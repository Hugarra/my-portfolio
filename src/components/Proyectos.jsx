            ...
            <div className="d-flex gap-5 justify-content-center pt-4">
                <div className="card" style={{width: 304}}>
                    <div className="card-body">
                        ...
                        <a href="https://github.com/Hugarra/form-w-d-mode" className="card-link">Project Github here</a>
                    </div>
                </div>
                <div className="card" style={{width: 304}}>
                    <div className="card-body">
                        ...
                        <a href="https://github.com/Hugarra/my-portfolio" className="card-link">Project Github here</a>
                    </div>
                </div>
            </div>
        </div>
